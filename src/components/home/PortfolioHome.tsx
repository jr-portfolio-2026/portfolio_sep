...
import { ArrowLeft, ArrowRight, ArrowUpRight, ChevronDown, Globe2, Scale, Waypoints } from "lucide-react";
import { useState } from "react";
import { Button } from "@/components/ui/button";
import fretPreview from "@/assets/fretio-preview.jpg";
...
const PROJECTS = [
  { name: "FRET.IO", category: "Calculation system", status: "Demo", image: fretPreview, relevance: "Applied software · structured calculation", problem: "Turns a technical fret-planning process into a controlled, repeatable calculation workflow.", working: "Core calculations, planning logic, and a demo-ready interface are operational.", improve: "Refine specialist workflows, validation, and finish toward a best-in-market instrument." },
  { name: "E4M", category: "Institutional redesign", status: "Draft", image: e4mPreview, relevance: "NGO · institutional systems", problem: "Reframes an NGO website as a clearer institutional information and programme system.", working: "The direction is approved and the principal experience is the most mature institutional study in the portfolio.", improve: "Expand programme depth, publishing structures, and the wider institutional architecture." },
  { name: "PES", category: "Productivity system", status: "Internal tool", image: pesPreview, relevance: "Operations · workflow design", problem: "Organises priorities and task progression for use in a real working environment.", working: "The core workflow is practical and actively usable for day-to-day planning.", improve: "Resolve small interaction issues and strengthen reporting across longer cycles." },
  { name: "Payote", category: "Strategic redesign", status: "Case study", image: payotePreview, relevance: "French commerce · brand strategy", problem: "Reconsiders a French brand’s website through commercial positioning and digital presentation.", working: "A coherent strategic and visual direction demonstrates the redesign thesis.", improve: "Develop the commerce journey, content system, and final production detail." },
];
